...
MODULE_WEIGHT(OCB_SCALE_WEIGHT, 0)
...
// Modulo 2.3 v3 - correcao do early-out
TUNE_PARAM(OCB_MAX_TOTAL_PIECES, 10, 6, 14, 1)

// Modulo 2.3 v4 - curva suave de dampening
TUNE_PARAM(OCB_DAMPEN_START_PAWNS, 3, 1, 6, 1)
TUNE_PARAM(OCB_DAMPEN_PER_PAWN, 12, 5, 25, 2)
TUNE_PARAM(OCB_DAMPEN_START_PIECES, 8, 4, 12, 1)
TUNE_PARAM(OCB_DAMPEN_PER_PIECE, 8, 3, 20, 2)
TUNE_PARAM(OCB_DAMPEN_FLOOR_PCT, 40, 10, 70, 5)
